        ...
        <div class="order-section">
            ...
            if (isset($_SESSION['carrito'])) {
                ...
                if ($response['code'] == 200) {
                    ...
                    echo "<img src='../img/producto.jpeg' alt='" . htmlspecialchars($producto['nombreProducto']) . "' style='width:100%; max-width:300px; padding-left: 20px;'>";
                    ...
                    switch ($_SESSION['carrito']['presentacion']) {
                        case "Pequeño":
                            ...
                            break;
                        case "Mediano":
                            $precio = $producto['precioVenta2'];
                            break;
                        case "Grande":
                            $precio = $producto['precioVenta3'];
                            break;
                    }

                    echo "<p class='order-detail'>Presentación: " . htmlspecialchars($_SESSION['carrito']['presentacion']) . "</p>";
                    echo "<p class='order-detail'>Tipo de molido: " . htmlspecialchars($_SESSION['carrito']['molido']) . "</p>";
