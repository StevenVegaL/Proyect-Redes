<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $url = 'http://microuser:3001/api/users/update/' . $id;
    ...
    $url = 'http://microuser:3001/api/users/' . $id;
...
<body>
    ...
    <form action="editar_usuario.php?ClienteID=<?= htmlspecialchars($id) ?>" method="post" class="user-edit-form">
        ...
        <input type="text" name="Teléfono" value="<?= htmlspecialchars($cliente['telefono']) ?>" required maxlength="9" class="form-input">
